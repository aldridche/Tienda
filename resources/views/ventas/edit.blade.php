    ...
    <div class="margen">
        <div class="panel-heading">
           Editar
            ...
            {!!Form::model($ventas, ['route'=>['ventas.update',$ventas->id],'method'=>'PUT'])!!}

            <div class="form-group">
                {!!form::label('Producto')!!}
                {!! form::select('productos_id',$productos,null,['id'=>'productos_id','class'=>'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                {!!form::label('RFC')!!}
                {!!Form::select('clientess_id',$clientes,null,['id'=>'clientess_id','class'=>'form-control']) !!}
